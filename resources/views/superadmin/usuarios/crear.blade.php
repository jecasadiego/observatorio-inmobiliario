<x-app-layout>
    <div class="container">
        ...
        <x-header>
            <x-slot name="texto">Crear Nuevo Usuario</x-slot>

        </x-header>
    </div>

    <div class="container mt-5 mb-5">
        <form action="{{ route('superadmin.usuarios_store') }}" method="POST" enctype="multipart/form-data">
            <div class="card mb-3 p-3 bg-light shadow rounded ">
                <div class="card-body">
                    <h5 class="card-title mb-4">Nuevo usuario</h5>
                    @csrf
                    <div class="row">
